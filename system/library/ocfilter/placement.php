...
class Placement extends Factory {
  ...
  public function isNew() {
      //echo 'isNew';
      //print_r($this->seo->getRoute());
    return ($this->seo->getRoute() == 'product/new' && $this->isModuleInLayout());
  }
