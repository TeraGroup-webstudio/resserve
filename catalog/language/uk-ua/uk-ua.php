...
$_['text_availability']       = 'Повідомити про наявність';
$_['text_compare']      = 'Порівняння (%s)';
$_['text_popular_asc']   = 'Популярні (за зростанням)';
$_['text_popular_desc']  = 'Популярні (за зменшенням)';
...
$_['button_wishlist']       = 'Додати до обраного';
