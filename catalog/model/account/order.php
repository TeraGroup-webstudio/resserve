...
class ModelAccountOrder extends Model {
	...
	public function getOrders($start = 0, $limit = 20) {
		...
		$query = $this->db->query("SELECT o.order_id, o.firstname, o.lastname, o.order_status_id, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value, oc.order_status_text_color, oc.order_status_background_color 
		FROM `" . DB_PREFIX . "order` o 
		LEFT JOIN " . DB_PREFIX . "order_status_colors oc ON (o.order_status_id = oc.order_status_id) 
