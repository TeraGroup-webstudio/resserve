...
class ModelAccountAddress extends Model {
	...
	public function getAddresses() {
		...
		foreach ($query->rows as $result) {
            ...
            $zone_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "zone` z LEFT JOIN `" . DB_PREFIX . "zone_description` zd ON(z.zone_id=zd.zone_id) WHERE z.zone_id = '" . (int)$result['zone_id'] . "' AND zd.language_id = '".(int)$this->config->get('config_language_id')."'");
