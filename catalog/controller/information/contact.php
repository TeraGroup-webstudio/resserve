...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$data['open'] = nl2br($this->config->get('config_open')[(int)$this->config->get('config_language_id')]);
		$data['comment'] = nl2br($this->config->get('config_comment')[(int)$this->config->get('config_language_id')]);
