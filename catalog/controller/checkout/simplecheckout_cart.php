    ...
    public function index() {
        ...
        foreach ($products as $product) {
            ...
            if($product['manufacturer']){
                ...
                $manufacturer_info = $this->model_catalog_manufacturer->getManufacturer($product['manufacturer']);
            ...
            if ($version >= 200) {
                ...
                $this->_templateData['products'][] = array(
                    ...
                    'price'     => $price,
                    'total'     => $total,
                    'manufacturer_href'      => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $product['manufacturer']),
