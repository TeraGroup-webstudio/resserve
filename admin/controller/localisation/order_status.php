...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$order_status_colors = $this->model_localisation_order_status->getOrderStatusColors($result['order_status_id']);
			$data['order_statuses'][] = array(
	...
	protected function getForm() {
		...
		if (isset($this->request->post['order_status_text_colors'])) {
			$data['order_status_text_colors'] = $this->request->post['order_status_text_colors'];
		} elseif (isset($this->request->get['order_status_id'])) {
			$data['order_status_text_colors'] = $this->model_localisation_order_status->getOrderStatusColors($this->request->get['order_status_id']);
		} else {
			$data['order_status_text_colors'] = array();
		}
