...
class ControllerSettingSetting extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['config_logo1'])) {
            $data['config_logo1'] = $this->request->post['config_logo1'];
        } else {
            $data['config_logo1'] = $this->config->get('config_logo1');
        }

        if (isset($this->request->post['config_logo1']) && is_file(DIR_IMAGE . $this->request->post['config_logo1'])) {
            $data['logo1'] = $this->model_tool_image->resize($this->request->post['config_logo1'], 100, 100);
        } elseif ($this->config->get('config_logo1') && is_file(DIR_IMAGE . $this->config->get('config_logo1'))) {
            $data['logo1'] = $this->model_tool_image->resize($this->config->get('config_logo1'), 100, 100);
        } else {
            $data['logo1'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        }

        if (isset($this->request->post['config_logo_menu'])) {
            $data['config_logo_menu'] = $this->request->post['config_logo_menu'];
        } else {
            $data['config_logo_menu'] = $this->config->get('config_logo_menu');
        }

        if (isset($this->request->post['config_logo_menu']) && is_file(DIR_IMAGE . $this->request->post['config_logo_menu'])) {
            $data['logo11'] = $this->model_tool_image->resize($this->request->post['config_logo_menu'], 100, 100);
        } elseif ($this->config->get('config_logo_menu') && is_file(DIR_IMAGE . $this->config->get('config_logo_menu'))) {
            $data['logo11'] = $this->model_tool_image->resize($this->config->get('config_logo_menu'), 100, 100);
        } else {
            $data['logo11'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        }
