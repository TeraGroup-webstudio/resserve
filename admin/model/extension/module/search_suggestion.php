<?php
 class ModelExtensionModuleSearchSuggestion extends Model{public function install(){$this->load->model('design/layout');$a3af44add8d15065b9f9252bb2f68b140=$this->model_design_layout->getLayouts();foreach($a3af44add8d15065b9f9252bb2f68b140 as $ad23122416ae5be93c251b88e736b32ef){$this->db->query("INSERT INTO ".DB_PREFIX."layout_module SET layout_id = '".(int)$ad23122416ae5be93c251b88e736b32ef['layout_id']."', code = 'search_suggestion', position = 'content_top', sort_order = '0'");}}public function getDefaultOptions(){return array('element'=>"#search input[name='search']",'types_order'=>array('manufacturer'=>array('sort'=>0),'category'=>array('sort'=>1),'category_filter'=>array('sort'=>2),'product'=>array('sort'=>3),'information'=>array('sort'=>4),),'width'=>"100%",'color_scheme'=>"#1cbaf7",'css'=>' 
