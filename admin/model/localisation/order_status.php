...
class ModelLocalisationOrderStatus extends Model {
	public function addOrderStatus($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "order_status_colors SET order_status_id = '" . (int)$order_status_id . "', order_status_text_color = '" . $this->db->escape($data['order_status_text_color']) . "', order_status_background_color = '" . $this->db->escape($data['order_status_background_color']) . "'");
	...
	public function editOrderStatus($order_status_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "order_status_colors WHERE order_status_id = '" . (int)$order_status_id . "'");
	...
	public function getOrderStatusColors($order_status_id) {
		$order_status_data_colors = array();

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_status_colors WHERE order_status_id = '" . (int)$order_status_id . "'");
