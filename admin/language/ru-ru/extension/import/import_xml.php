...
$_['text_cron']     = 'Крон';
$_['text_url_start']     = 'Подготовить данные для импорта';
$_['text_url_category']     = 'Импортировать данные категории';
$_['text_url_product']     = 'Импортировать данные товаров';
$_['text_url_attr']     = 'Импортировать данные характеристик';
$_['text_url_photo']     = 'Импортировать фото товаров';
...
$_['entry_setting_product_disable_status']     = 'Отключать товар (если товара нет в файле)';

$_['button_file']     = 'Файл';
$_['button_url']     = 'Ссылка';


$_['help_type_download']     = 'Либо с файла, либо по ссылке. Если настроен крон, то файл будет создаваться автоматически. Поле для ссылке обязательно к заполнению.';
